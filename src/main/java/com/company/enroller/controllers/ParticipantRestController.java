...
public class ParticipantRestController {
    ...
    public ResponseEntity<?> registerParticipant(@RequestBody Participant participant) {
        ...
        if (foundParticipant != null) {
            return new ResponseEntity<>("Unable to create. A participant with login", HttpStatus.CONFLICT);
        }
    ...
    public ResponseEntity<?> deleteParticipant(@PathVariable String login) {
        ...
        if (foundParticipant == null) {
            return new ResponseEntity<>("Unable to delete. Participant doesn't exist", HttpStatus.NOT_FOUND);
        }
    ...
    public ResponseEntity<?> updateParticipant(@RequestBody Participant updatedParticipant, @PathVariable("id") String login) {
        ...
        if (existing == null) {
            return new ResponseEntity<>("Unable to update. Participant doesn't exist", HttpStatus.NOT_FOUND);
        }
